...
<html lang="en-ca">
  ...
  <body>
    ...
    <?php
      echo "<h2>Los Pollos Hermanos was founded by Chilean nationals and business partners Gus Fring and Max Arciniega in Mexico. They were inspired by recipes cooked by Gus' uncles.</h2>"
    ?>
    ...
    <form action="./results.php" method="post" target="results">
      ...
      <select name="bucket-choice" id="bucket-choice">
      ...
      <label for="userMain">Please enter the amount of buckets you wold like:</label>
          <input type="number" name="user-main" id="user-main" placeholder="ex.2" step="1" min="1" ><br><br>
        
      <!--- Get user information for what sauce --->
      <label for="sauceChoice">Sauce options:</label>
      <select name="sauce-choice" id="sauce-choice">
      ...
      <label for="sauceAmount">Please enter the amount of Sauces you would like:</label>
          <input type="number" name= "sauceAmount" id="sauceAmount" placeholder="ex.4" step="1" min="0"><br><br>
      ...
      <label for="userSideDrink">Please enter the amount of drinks you would like:</label>
        <input type="number" name= "userSideDrink" id="userSideDrink" placeholder="ex.3" step="1" min="0"><br><br>

      <!--- Get user information for fries --->
      <label for="friesChoice">Fries options:</label>
      <select name="fries-choice" id="fries-choice">
      ...
      <label for="userSideFries">Please enter the amount of fries you would like:</label>
        <input type="number" name= "userSideFries" id="userSideFries" placeholder="ex.2" step="1" min="0"><br><br>
      ...
      <iframe id="results" name="results">			
        ...
        ?>
          ...
          <!-- image of Los Pollos Hermanos -->
          <img src="./images/Los_Pollos_Hermanos.webp" width="600">
	</body>
</html>